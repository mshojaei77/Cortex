...
class RAGSystem:
    ...
    def run_query(self, query_str="Please provide a comprehensive summary of the key points and main ideas from these documents") -> str:
        try:
            ...
            # Generate answer using the LLM and return it
    ...
    def run(self, query_str="Please provide a comprehensive summary of the key points and main ideas from these documents"):
        # Fallback main method if running as a script, simply call run_query().
        answer = self.run_query(query_str)
        print("\nQuestion:", query_str)
        print("\nAnswer:", answer)
...
if __name__ == '__main__':
    ...
    rag_system.run(query_str)  # Execute as a script
